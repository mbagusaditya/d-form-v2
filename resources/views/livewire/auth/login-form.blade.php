<form wire:submit.prevent="submit">
    ...
    <a href="/" class="text-neutral dark:text-base-content link mt-3 inline-block text-sm">
        {{ __('auth.forgot_password') }}
    </a>

    <button class="btn btn-primary btn-lg mt-4 w-full rounded-lg lg:text-lg" wire:loading.attr="disabled">
        Submit
    </button>
    ...
    <div class="flex flex-col justify-center gap-4">
        ...
        >
            ...
            <span class="text-sm font-medium">{{ __('auth.sign_in_with') . __('auth.google') }}</span>
        </a>
        ...
        >
            ...
            <span class="text-sm font-medium">{{ __('auth.sign_in_with') . __('auth.github') }}</span>
        </a>
    </div>
</form>
